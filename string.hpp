...
public:	
    ...
    String        (const char, int size = 2); // Initialize Sting to a single char
    String        (const char[], int size = default_size); // Initialize Sting to char array
    String(const String& str, int cap = default_size); // copy constructor
    ~String       (); // destructor
    ...
    int length() const { return strLength; }; // returns the length of a string
